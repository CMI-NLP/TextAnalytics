...
%\usepackage{fontspec}
%% \setsansfont{Ubuntu Sans} % or any other system font like Helvetica, Arial, etc
\usepackage[T1]{fontenc}
\usepackage[scaled=0.]{helvet}
\usepackage{fontspec}
% Set Helvetica Light as the main font
\setmainfont{Helvetica Light}[
  Path = /path/to/font/files/, % Optional: specify the path to the font files if necessary
  UprightFont = *,
  ItalicFont = *-Italic,
  BoldFont = *-Bold,
